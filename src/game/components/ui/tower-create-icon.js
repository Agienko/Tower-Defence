...
export class TowerCreateIcon extends Container{
    constructor(stage, descriptor) {
        ...
        this.rocket.on('pointerover', () => {
            this.rocketFilter.alpha = 1;
        })
        this.rocket.on('pointerout', () => {
            this.rocketFilter.alpha = 0.5;
        })
        ...
        this.bullet.on('pointerover', () => {
            this.bulletFilter.alpha = 1;
        })
        this.bullet.on('pointerout', () => {
            this.bulletFilter.alpha = 0.5;
        })
